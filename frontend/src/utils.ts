...
export function nodeLabel(nodeType: string, data: Record<string, string>, startMessage?: string | null, name?: string | null): string {
  return name || startMessage || data.name || data.label || data.operation || data.title || nodeType;
}
